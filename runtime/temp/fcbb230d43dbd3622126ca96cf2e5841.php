<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"C:\Users\asus\Desktop\shouye\public/../application/admin\view\index\editsms.html";i:1507879716;s:42:"../application/admin/view/public/head.html";i:1507803847;s:44:"../application/admin/view/public/header.html";i:1507788118;s:42:"../application/admin/view/public/menu.html";i:1507783288;s:41:"../application/admin/view/public/nva.html";i:1507712749;s:44:"../application/admin/view/public/footer.html";i:1507782375;}*/ ?>
<!--引入资源文件-->
<!doctype html>
<html>
                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" action="" id="formid" enctype="multipart/form-data">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="sms_sign" value="<?php echo $smsOneList['sms_sign']; ?>" name="sms_sign" class="am-form-field tpl-form-no-bg" placeholder="短信签名" />
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" value="<?php echo $smsOneList['sms_tpl_code']; ?>"  id="sms_tpl_code" name="sms_tpl_code" placeholder="短信模板ID">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{btnSize: 'sm'}" name="send_scene" id="rule_id" onchange="getSmstemplate(this.options[this.options.selectedIndex].value)">
                                        ...
                                        <?php if(is_array($smsres) || $smsres instanceof \think\Collection || $smsres instanceof \think\Paginator): $i = 0; $__LIST__ = $smsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $v['send_scene']; ?>" <?php if($v['send_scene'] == $smsOneList['send_scene']): ?>selected="selected"<?php endif; ?>><?php echo $v['sms']; ?></option>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea readonly="readonly"  name="tpl_content"  rows="5" id="smssend"><?php echo $smsOneList['tpl_content']; ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <input type="hidden" name="tpl_id" value="<?php echo $smsOneList['tpl_id']; ?>">
...
<script>
    function submits() {
        if($('#sms_sign').val()== ''){
            ...
            $.ajax({
                url:"<?php echo url('admin/Index/editSms'); ?>",
                type: 'post',
    ...
    function getSmstemplate(value) {
        ...
        $.ajax({
            url: "<?php echo url('admin/Index/getOption'); ?>",
            type: 'post',
            data:{
                id:value
            },
