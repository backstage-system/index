<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"C:\Users\asus\Desktop\shouye\public/../application/admin\view\index\smstemplates.html";i:1507878680;s:42:"../application/admin/view/public/head.html";i:1507803847;s:44:"../application/admin/view/public/header.html";i:1507788118;s:42:"../application/admin/view/public/menu.html";i:1507783288;s:41:"../application/admin/view/public/nva.html";i:1507712749;s:44:"../application/admin/view/public/footer.html";i:1507782375;}*/ ?>
<!--引入资源文件-->
<!doctype html>
<html>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    <td><?php echo $k; ?></td>
                                    <td>
                                        <?php switch($v['send_scene']): case "1": ?>用户注册<?php break; case "2": ?>用户找回密码<?php break; case "3": ?>审核用户充值积分<?php break; case "4": ?>积分充值订单提交<?php break; case "5": ?>用户提现验证码<?php break; case "6": ?>用户提现成功通知<?php break; endswitch; ?>
                                    </td>
                                    <td><?php echo $v['sms_sign']; ?></td>
                                    <td><?php echo $v['sms_tpl_code']; ?></td>
                                    <td><?php echo $v['tpl_content']; ?></td>
                                    <td><?php echo date('Y-m-d H:i',$v['add_time']); ?></td>
                                    <td>
                                        <button onclick='location.href="<?php echo url('admin/Index/editSms',['id'=>$v['tpl_id']]); ?>"' type="button" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                        <button onclick='del("<?php echo $v['tpl_id']; ?>",this)' type="button" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-trash-o"></span> 删除</button>
                                    </td>
                                </tr>
...
<script>
    function href() {
        location.href = "<?php echo url('Admin/Index/addSmsTemplate'); ?>";
    }
    ...
    function del(id,obj) {
        layer.confirm('确认删除么？', {
            ...
            $.ajax({
                url: "<?php echo url('admin/Index/delSms'); ?>",
                type: 'post',
                data:{
                    id:id
                },
