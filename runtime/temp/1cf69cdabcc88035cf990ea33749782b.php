<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"C:\Users\asus\Desktop\shouye\public/../application/admin\view\user\index.html";i:1508121024;s:42:"../application/admin/view/public/head.html";i:1507803847;s:44:"../application/admin/view/public/header.html";i:1507788118;s:42:"../application/admin/view/public/menu.html";i:1507783288;s:41:"../application/admin/view/public/nva.html";i:1507712749;s:44:"../application/admin/view/public/footer.html";i:1507782375;}*/ ?>
<!--引入资源文件-->
<!doctype html>
<html>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-department">部门</th>
                                    <th class="table-rule">拥有角色</th>
                                    <th class="table-phone am-hide-sm-only">手机号</th>
                                    <th class="table-email am-hide-sm-only">邮箱</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $k; ?></td>
                                    <td>
                                        <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $v['avatar']; ?>" data-lightbox="lightbox-test" data-title="用户头像">
                                        <img width="48" height="48" src="<?php echo admin_thumb_img($v['id'] , 48,48,'admin/user','admin_thumb_'); ?>" alt="">
                                        </a></td>
                                    ...
                                    <td class="am-hide-sm-only"><?php echo date("Y-m-d H:i:s",$v['register_time']); ?></td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button onclick='location.href="<?php echo url('admin/User/editUser',['id'=>$v['id']]); ?>"' type="button" class="am-btn am-btn-default"><span class="am-icon-pencil-square-o"></span> 编辑</button>
...
<script>
    function href() {
        location.href= '/admin/User/add_user';
    }
