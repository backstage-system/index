<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"C:\Users\asus\Desktop\shouye\public/../application/admin\view\rule\rule_group.html";i:1507777052;s:42:"../application/admin/view/public/head.html";i:1507803847;s:44:"../application/admin/view/public/header.html";i:1507788118;s:42:"../application/admin/view/public/menu.html";i:1507783288;s:41:"../application/admin/view/public/nva.html";i:1507712749;s:44:"../application/admin/view/public/footer.html";i:1507782375;}*/ ?>
﻿<!--引入资源文件-->
<!doctype html>
<html>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-avatar">角色名</th>
                                    <th class="table-set">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button onclick='location.href="<?php echo url('admin/Rule/rule_distribution',['id'=>$v['id']]); ?>"' type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span>分配权限</button>
                                                <button onclick='location.href="<?php echo url('admin/Rule/edit_group',['id'=>$v['id']]); ?>"' type="button" class="am-btn am-btn-default"><span class="am-icon-pencil-square-o"></span> 更新</button>
                                                <button onclick='del("<?php echo $v['id']; ?>",this)' type="button" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span> 删除</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    function del(id,obj) {
        layer.confirm('确认删除么？', {
            ...
            $.ajax({
                url: "<?php echo url('admin/Rule/delete_group'); ?>",
                type: 'post',
                dataType: 'json',
                data:{id:id},
    ...
    function edit(id) {
        location.href = "<?php echo url('admin/User/editUser',['id'=>'"+id+"']); ?>";
    }
</script>
</html>